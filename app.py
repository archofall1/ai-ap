...
st.set_page_config(page_title="Nextile AI (Gemini 3)", page_icon="🤖", layout="wide")
...
# 9. THE INTERACTIVE PLUS BUTTON (NO DRAG & DROP BOX)
# We use st.popover to hide the uploader inside a small clickable button
...
if prompt:
    ...
    with st.chat_message("assistant"):
        ...
        system_instruction = {
            "role": "system", 
            "content": "Your name is Gemini 3. You were created by Knight. Be kid-friendly, never rude, and never mention inappropriate/sexual topics. Credit Knight in fun ways if asked who made you."
        }
        ...
        try:
            ...
            st.error("Nextile AI  had a hiccup. Please refresh your page to try again.")
